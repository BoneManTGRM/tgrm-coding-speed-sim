/* ============================================================
   TGRM AutoViz PRO — Enhanced adaptive repair simulator
...
function run(){
  ...
  // 🔔 Notify iframe hosts (for dark pages)
...
console.log("✅ TGRM AutoViz PRO loaded — adaptive repair visualization active.");
